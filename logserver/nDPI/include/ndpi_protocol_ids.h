...
#define NDPI_PROTOCOL_OICQ    231  //byzpl qq(oicq.c)
#define NDPI_PROTOCOL_WEIBO  232//byzpl weibo


/* UPDATE UPDATE UPDATE UPDATE UPDATE UPDATE UPDATE UPDATE UPDATE */
#define NDPI_LAST_IMPLEMENTED_PROTOCOL		       NDPI_PROTOCOL_WEIBO    // NDPI_PROTOCOL_FIX
