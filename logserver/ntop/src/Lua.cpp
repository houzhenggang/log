 ...
 *///获取根据标准分组的网络接口的主机信息   (子网网段的主机统计情况)
...
//    NetworkInterface *ntop_interface = getCurrentInterface(vm);//获取当前网卡
//    /*init*/
...
//    lua_newtable(vm);
//    ntop->getPrefs()->reloadPrefsFromRedis();// from redis 下载配置参数
...
static const char **make_argv(lua_State * vm, u_int offset) {
    ...
    for(i=0; i<argc; i++) {
        u_int idx = i + offset;
        /* accepts string or number */    /*~lua_isstring()->取值操作判断是否可以转为string~*/
...
void lua_push_str_table_entry(lua_State *L, const char *key, char *value) {
    if(L) {
        ...
        lua_settable(L, -3);//这个函数会把键和值都从堆栈中弹出。
    }
}
...
//    /* Host */
////    { "getHostsInfo",           ntop_get_interface_hosts_info },//获取网络接口的所有host信息  location_all
////    { "getLocalHostsInfo",      ntop_get_interface_local_hosts_info },//获取网络接口的本地host信息 location_local_only
////    { "getRemoteHostsInfo",     ntop_get_interface_remote_hosts_info },//获取网络接口的远程host信息 location_remote_only
//    { "getHostInfo",            ntop_get_interface_host_info },//获取网络接口的指定host信息
//    { "getGroupedHosts",        ntop_get_grouped_interface_hosts},//子网网段的host统计情况
...
//    /* Flow */
// //   { "getFlowsInfo",           ntop_get_interface_flows_info },/*遍历获取所有flow*/
//    { "getFlowsStats",          ntop_get_interface_flows_stats},
//    { "getFlowKey",             ntop_get_interface_flow_key   },
//    { "findFlowByKey",          ntop_get_interface_find_flow_by_key },//获取指定flow
...
//    { "getLatestActivityHostsInfo",     ntop_get_interface_latest_activity_hosts_info },//获取接口最新的host信息
...
//    /* Mac */
// //   { "getMacsInfo",                    ntop_get_interface_macs_info },//获取接口的所有mac信息
//    { "getMacInfo",                     ntop_get_interface_mac_info },//获取接口的指定mac信息
//  //  { "getMacManufacturers",            ntop_get_interface_macs_manufacturers },

//    /* Autonomous Systems */  //对应后台host/Autonomous Systems
//  //  { "getASesInfo",                    ntop_get_interface_ases_info },//所有
//    { "getASInfo",                        ntop_get_interface_as_info },//指定
